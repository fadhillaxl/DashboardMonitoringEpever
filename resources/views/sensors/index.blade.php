...
@section('content')
    ...
    @if ($time)
        <div class="row mb-4">
            <div class="col col-12 col-md-6">
                <div class="mb-3 text-start">
                    <span class="badge bg-info fs-6">Last Update: {{ $time }}</span>
                </div>
            </div>
        ...
        {{-- Temperature --}}
        <div class="row g-3 mb-5 border rounded p-4 pt-2 bg-white shadow-sm">
                    ...
                    <div class="card h-100 shadow-sm bg-white text-dark text-center">
                        <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-1 small text-uppercase">
                                <i class="bi bi-thermometer"></i> {{ $sensor['label'] }}
                            </p>
        ...
        {{-- Humidity --}}
        <div class="row g-3 border rounded p-4 pt-2 bg-white shadow">
            <h5 class="mt-4 mb-2 fw-bold">
            ...
            @foreach ($humidities as $sensor)
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="card h-100 shadow-sm bg-white text-dark text-center">
                        <div class="card-body d-flex flex-column justify-content-center">
                            <p class="mb-1 small text-uppercase">
                                <i class="bi bi-droplet"></i> {{ $sensor['label'] }}
                            </p>
