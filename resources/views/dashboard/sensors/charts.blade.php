...
@section('content')
    <h2 class="mb-4 text-start fw-bold">Sensors Charts - {{ $mac_address }}</h2>
                ...
                @if ($col !== 'time')
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="card bg-white text-dark p-3 shadow-sm">
                            ...
                            <canvas id="chart-{{ Str::slug($col) }}"></canvas>
...
@push('scripts')
    ...
    <script>
        ...
        Object.keys(rows[0] || {}).forEach(col => {
            ...
            const ctx = document.getElementById('chart-' + col.replace(/\s+/g, '-').toLowerCase()).getContext('2d');
